...
a = threading.Thread(target=client, args=(ip, port, {"op": "eval", "code": '(def a (input))'}, 1))
a.start()
time.sleep(2)
del a
b = threading.Thread(target=client, args=(ip,port, {"op": "stdin", "value": "test"}, 2))
b.start()
time.sleep(2)
del b
c = threading.Thread(target=client, args=(ip,port, {"op": "eval", "code": "(print a)"}, 3))
c.start()
time.sleep(2)
del c
print("del")
